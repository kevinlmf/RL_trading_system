...
for env_name, env in environments.items():
    print(f"\n🚀 Training PPO in [{env_name}] environment...")
    ...
    # Save model
    model_path = f"models/ppo_actor_critic_{env_name.lower()}.pt"
...
for env_name, rewards in reward_history.items():
    ...
    plt.plot(smooth_rewards, label=f"{env_name} PPO")
...
plt.title("PPO Training: Copula vs Baseline")
plt.xlabel("Episode")
plt.ylabel("Smoothed Total Reward (normalized)")
plt.legend()
plt.grid(True)
plt.tight_layout()
plot_path = "results/ppo_copula_vs_baseline_metrics.png"
